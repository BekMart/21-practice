...
- The cards are dealt to each player next to where their scores are displayed, symmetrically and separated by the game control buttons.
- The buttons change depending on the device width. 
    - All the buttons are aligned horizontally on larger devices. 
    - On smaller devices the deal button is elevated above the other two game control buttons.
    - The settings buttons at the bottom of the page align vertically on smaller devices. 
...
This website consists of one page which hosts the game itself and a 404-error page which is displayed in the URL is entered incorrectly.  
...
![The opponent score area is at the top of this section set darker, to enhance the gold font which displays a question mark for opponent score and games won tally. Underneath this are the opponent's cards. The first of which is hidden, just showing the back of the card, whilst the second is revealed.][opponent-side]
...
![There are three game control buttons in the center of the game section. These are hit, deal and stay. The deal button is in the center and is slightly larger than the other two.][game-controls]
...
- I can confirm that all the functions work as expected: 
    ...
    - The opponent score is revealed after the stay button has been activated and their cards have been revealed.
...
- I want the game to be responsive on all devices so that it can be enjoyed anywhere 
    ...
    - A media query has also been used to style some of the buttons and features to ensure that they fit nicely on the page at all times. 
...
- I want to easily navigate around the page and play the game
    ...
    - The buttons are all labeled clearly, and the game rules explain how and when to use them in simple terms.  
- I want to be able to compete against the computer and know what my score is
